...
export function MusicPlayer() {
  ...
  return (
    <Card className="fixed bottom-14 md:bottom-0 left-0 md:left-12 md:peer-data-[state=expanded]:left-64 right-0 rounded-b-none border-t bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80 shadow-2xl transition-[left] duration-200 ease-linear">
