        ...
        <SidebarProvider>
          <PageHeaderProvider>
            ...
            <SidebarInset className="px-3 md:px-4">
              ...
              <main className={`flex-1 pt-3 md:pt-4 ${currentTrack || isRemote ? 'pb-36 md:pb-36' : 'pb-20 md:pb-8'}`}>{children}</main>
            </SidebarInset>
...
function ProfileAvatarLink() {
  ...
  return (
    <Link to="/profile" className="md:hidden" aria-label={user?.name || 'Profile'}>
