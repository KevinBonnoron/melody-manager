...
function SearchResultItem({ origin, provider, image, Icon, title, subtitle, status, isAdding, onAdd }: SearchResultItemProps) {
...
export function AlbumResultItem({ result, status, isAdding, onAdd }: AlbumResultItemProps) {
  ...
  return <SearchResultItem origin={result.origin} provider={result.provider} image={result.coverUrl ?? ''} Icon={Disc} title={result.name} subtitle={<Subtitle left={result.artist ?? ''} right={right} />} status={status} isAdding={isAdding} onAdd={onAdd} />;
}
...
export function ArtistResultItem({ result, status, isAdding, onAdd }: ArtistResultItemProps) {
  ...
  return <SearchResultItem origin={result.origin} provider={result.provider} image={result.coverUrl ?? ''} Icon={User} title={result.name} subtitle={<Subtitle left={result.genres?.join(', ') ?? ''} right={right} />} status={status} isAdding={isAdding} onAdd={onAdd} />;
}
