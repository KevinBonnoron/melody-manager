...
migrate((app) => {
  const snapshot = [
    ...
    },
    {
      ...
      "id": "pbc_4185980916",
      "indexes": [
        "CREATE UNIQUE INDEX `idx_F09wpzOsCD` ON `artists` (`name`)"
      ],
      "listRule": "",
      "name": "artists",
      "system": false,
    ...
    },
    {
      ...
      "id": "pbc_2683869272",
      "indexes": [
        "CREATE UNIQUE INDEX `idx_E3565MbIQs` ON `genres` (`name`)"
      ],
      "listRule": "",
      "name": "genres",
      "system": false,
    ...
    },
    {
      ...
      "id": "pbc_3385642926",
      "indexes": [
        "CREATE UNIQUE INDEX `idx_Fmpdumni3s` ON `track_likes` (\n  `user`,\n  `track`\n)"
      ],
    ...
    },
    {
      ...
      "id": "pbc_3481478959",
      "indexes": [
        "CREATE UNIQUE INDEX `idx_XJUhA25tyV` ON `album_likes` (\n  `user`,\n  `album`\n)"
      ],
      "listRule": "@request.auth.id != '' && user = @request.auth.id",
      "name": "album_likes",
      "system": false,
    ...
    },
    {
      ...
      "id": "pbc_2120104488",
      "indexes": [
        "CREATE UNIQUE INDEX `idx_c6MamGy1Cs` ON `artist_likes` (\n  `user`,\n  `artist`\n)"
      ],
      "listRule": "@request.auth.id != '' && user = @request.auth.id",
      "name": "artist_likes",
      "system": false,
    ...
    },
    {
      ...
      "id": "pbc_1774664135",
      "indexes": [
        "CREATE UNIQUE INDEX `idx_track_dislikes_user_track` ON `track_dislikes` (\n  `user`,\n  `track`\n)"
      ],
      "listRule": "@request.auth.id != '' && user = @request.auth.id",
      "name": "track_dislikes",
      "system": false,
    ...
    },
    {
      ...
      "id": "pbc_1573964244",
      "indexes": [
        "CREATE UNIQUE INDEX `idx_IPFq2YZ0bi` ON `provider_grants` (\n  `provider`,\n  `user`\n)"
      ],
    ...
    },
    {
      ...
      "indexes": [
        "CREATE UNIQUE INDEX `idx_playlist_likes_user_playlist` ON `playlist_likes` (\n  `user`,\n  `playlist`\n)"
      ],
      "listRule": "@request.auth.id != '' && user = @request.auth.id",
      "name": "playlist_likes",
      "system": false,
