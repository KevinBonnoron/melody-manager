...
class FfmpegCommand {
  public constructor(private readonly options: FFmpegOptions = {}) {}

  public input(input: string, inputArgs?: string[]) {
  ...
  public audioFilter(audioFilter: AudioFilter) {
    return new FfmpegCommand({ ...this.options, audioFilter });
  }

  public codec(codec: CodecOptions) {
    return new FfmpegCommand({ ...this.options, codec });
  }

  public seekInput(start?: number | string, end?: number | string) {
    return new FfmpegCommand({ ...this.options, inputSeek: { start, end } });
  }

  public seekOutput(start?: number | string, end?: number | string) {
    return new FfmpegCommand({ ...this.options, outputSeek: { start, end } });
  }

  public duration(duration: number | string) {
  ...
  public metadata(metadata: MetadataOptions) {
    return new FfmpegCommand({ ...this.options, metadata });
  }

  public map(...streams: string[]) {
  ...
  public async run(options?: { onStdout?: (data: Buffer) => void; onStderr?: (data: Buffer) => void }): Promise<void> {
